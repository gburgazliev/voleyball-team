...
<div id="mobile-theme-switch" onClick={() => setTheme(true)}>
            ...
            <Drawer placement={'left'} onClose={onClose} isOpen={isOpen}>
                ...
                <DrawerContent bg='gray.800'>
                    <DrawerHeader borderBottomWidth='1px' id='drawer-header'>Menu</DrawerHeader>
                    <DrawerCloseButton id='drawer-close-button' _hover={{ color: 'blue.200', cursor: 'pointer' }} />
